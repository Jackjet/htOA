...
<br/>
<form:form commandName="purchaseCheckInforVo" id="purchaseCheckInforForm" name="purchaseCheckInforForm" action="/ywpurchase/checkInfor.do?method=editSave" method="post" enctype="multipart/form-data">
				...
				<tbody>
					...
					<%--<c:if test="${_Purchase.purchaseStatus != 9}">--%>
						<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
							<td class="ui-state-default jqgrid-rownum" style="width: 15%">详细信息：</td>
							<td>
								<br/>
								...
								<form:textarea path="checkComment" cols="80" rows="2" />
								<div id="checkCommentTip"></div>
							<%--<br/>--%>
							</td>
						</tr>
					<%--</c:if>--%>
					...
					<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
						...
						<td>
							<form:input path="purchaseMoney" size="25" name="purchaseMoney"/>
							<br/>
						</td>
					</tr>
					<%--<c:if test="${_Purchase.purchaseStatus == 6}">--%>
						<%--<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">--%>
