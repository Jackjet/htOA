...
<br/>
<form:form commandName="purchaseCheckInforVo" id="purchaseCheckInforForm" name="purchaseCheckInforForm" action="/ywpurchase/checkInfor.do?method=save" method="post" enctype="multipart/form-data">
