...
<br/>
<form:form commandName="purchaseInforVo" id="purchaseInforForm" name="purchaseInforForm" action="/ywpurchase/purchase.do?method=saveEnd" method="post" enctype="multipart/form-data">
