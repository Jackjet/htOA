...
<br/>
<form:form commandName="purchaseInforVo" id="purchaseInforForm" name="purchaseInforForm" action="/ywpurchase/purchaseInfor.do?method=saveDepCheck" method="post" enctype="multipart/form-data">
					...
					<tbody>
						...
						<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
							...
							<td>
								...
								<input type="radio" name="checkWordR" value="2" id="bty" onclick="setCheckWord(this.value);" /><label for="bty">不同意</label><br/>
