	...
	<script type="text/javascript">     
		...
		function doView(rowId){
  		...
  		<div style="margin-top:0px;">
			<table id="listLatencyCustomer" style="width:99%"></table>
			<div id="pagerLatencyCustomer"></div>
		</div>	
		
		<!-- 查询框 -->
		<div id="multiSearchDialogLatencyCustomer" style="display: none;">  
		    <table>  
		        <tbody>  
		            <tr>  
		                <td>  
		...
		<script type="text/javascript"> 		
		   ...
		   function formatCompanyName(cellValue, options, rowObject) {			
			...
			//加载表格数据
			var $mygrid = jQuery("#listLatencyCustomer").jqGrid({ 
                url:'/customer/customerInfor.do?method=list&type=3',
                //rownumbers: true,
                datatype: "json",                
               	autowidth: true,               	
				//height: "auto",
                ...
                pager: "#pagerLatencyCustomer"
                //caption: "已收到的讯息"
        }).navGrid('#pagerLatencyCustomer',{edit:false,add:false,del:false,search:false});     
        
        $("gbox_listLatencyCustomer").css("width","100%");  
      		
		//自定义按钮
		$("#listLatencyCustomer").jqGrid('navButtonAdd','#pagerLatencyCustomer', {
		...
		function deleteCustomer(){
			doDelete("/customer/customerInfor.do?method=delete","listLatencyCustomer");
		}
