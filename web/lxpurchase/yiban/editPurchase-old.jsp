...
<head>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$("#purchaseTitle").formValidator({onshow:"请输入名称",onfocus:"名称不能为空"}).inputValidator({min:1,onerror: "请输入名称"});
			$("#purchaseGoods").formValidator({onshow:"请输入工程地址",onfocus:"工程地址不能为空"}).inputValidator({min:1,onerror: "请输入工程地址"});
            $("#purchaseNumber").formValidator({onshow:"请输入数量",onfocus:"数量不能为空"}).inputValidator({type:"number",min:1,onerror: "请输入正确的数量"});
			$("#guige").formValidator({onshow:"请输入单位",onfocus:"单位不能为空"}).inputValidator({min:1,onerror: "请输入单位"});
			$("#application").formValidator({onshow:"请输入备注",onfocus:"备注不能为空"}).inputValidator({min:1,onerror: "请输入备注"});
...
<br/>
	<form:form commandName="purchaseInforVo" id="purchaseInforForm" name="purchaseInforForm" action="/lxpurchase/purchaseInfor.do?method=save" method="post" enctype="multipart/form-data">
						...
						<tr><td style="width: 65%;">
							...
							<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 90%;">
								...
								<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
									<td class="ui-state-default jqgrid-rownum" style="width: 15%">名称：</td>
									<td>
							...
							<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 90%">
								<tbody>
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
										<td class="ui-state-default jqgrid-rownum" style="width: 18%">工程地址：</td>
										<td>
									...
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
										<td class="ui-state-default jqgrid-rownum" style="width: 18%">备注：</td>
										<td>
											<%--<form:input path="application" size="60" />--%>
											<form:textarea path="application" cols="35" rows="5" />
											&nbsp;
											<font color="red"></font>
										</td>
									</tr>
