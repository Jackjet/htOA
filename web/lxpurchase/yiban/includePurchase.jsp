...
<script>
	...
	<%--function editCheckInfor(checkId) {--%>
		<%--var path = "<c:url value='/lxpurchase/checkInfor.do'/>?method=edit&chargerEdit=true&instanceId=${_Purchase.instanceId}&checkId="+checkId;--%>
		<%--window.name = "__self";--%>
...
<link href="<c:url value="/"/>css/submit.css" type="text/css" rel="stylesheet">
	...
	<div>
	<c:if test="${Purchase.flowId.flowId == 4 }">
		...
		<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 90%">
			<tbody id="tblGrid">	
						<c:if test="${_Purchase.flowId.flowId == 4}">
						<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
							<td class="ui-state-default jqgrid-rownum" style="width: 20%">标题：</td>
							<td>${_Purchase.purchaseStr1}</td>
						</tr>
						<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
								<td class="ui-state-default jqgrid-rownum" style="width: 20%">名称：</td>
								<td>${_Purchase.purchaseTitle}</td>
						</tr>
						<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
							<td class="ui-state-default jqgrid-rownum" style="width: 20%">工程地址：</td>
						...
						<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
							<td class="ui-state-default jqgrid-rownum" style="width: 20%">备注：</td>
