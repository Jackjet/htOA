...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px">
            <li id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">收文管理</a></li>
            <li id="tabs_li_2" class="tabs_li"><a href="#tabs-grant">发文管理</a></li>
            <li id="tabs_li_3" class="tabs_li"><a href="#tabs-grant">合同审批</a></li>
            <li id="tabs_li_4" class="tabs_li"><a href="#tabs-grant">内部报告</a></li>
            <li id="tabs_li_5" class="tabs_li"><a href="#tabs-grant">制度评审</a></li>
            <li id="tabs_li_6" class="tabs_li dropdown-submenu">
                <a href="#tabs-grant">体系文件</a>
               <%-- <ul  class="nav nav-list dropdown-menu menuSideBar" style="margin-top: -160px">
                    <li onclick="a('FrameMsg.jsp?urlPath=${category.urlPath}',false)" >
                        <a class="lia" tabindex="-1" href="javascript:void(0);">aa</a>
                    </li>
                    <li onclick="a('FrameMsg.jsp?urlPath=${category.urlPath}',false)" >
                        <a class="lia" tabindex="-1" href="javascript:void(0);">bb</a>
                    </li>
                    &lt;%&ndash;<c:forEach var="category" items="${_CategoryMenu}" varStatus="index">
...
//            setFrameHeight()
        ...
        $("#tabs_ul li").click(function(){
            ...
            if(flag){
                ...
                var url = "";
                if(tabId == "tabs_li_1"){
                    url = "workflow/instanceInfor.jsp?flowId=84";
                } else if(tabId == "tabs_li_2"){

                    url = "workflow/instanceInfor.jsp?flowId=85";
                } else if(tabId == "tabs_li_3"){
                    url = "workflow/instanceInfor.jsp?flowId=86";
                }else if(tabId == "tabs_li_4"){
                    url = "workflow/instanceInfor.jsp?flowId=87";
                }else if(tabId == "tabs_li_5"){
                    url = "workflow/instanceInfor.jsp?flowId=88";
                }else if(tabId == "tabs_li_6"){
                    url = "workflow/instanceInfor_File.jsp";
                }else{
                    return;
                }
