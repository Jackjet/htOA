...
MzTreeView.prototype.initAll = function(nodes)
{
  ...
  {   
    ...
    if(nodes[i].id==1 || nodes[i].type=="1" || nodes[i].exclude=="1")   
     ...
     span.innerHTML="&nbsp;<a href=javascript:parent.send_sms('"+ user_id +"','"+ nodes[i].text +"') style='color:#FF0000;text-decoration:underline;'>短信</a>&nbsp;";
     span.innerHTML+="<a href=javascript:parent.send_email('"+ user_id +"','"+ nodes[i].text +"') style='color:#FF0000;text-decoration:underline;'>邮件</a>";
