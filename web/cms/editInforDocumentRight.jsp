...
<script language="javaScript">
	...
	//提交数据
	function submitData() {
		var form = document.inforDocumentForm;
		form.action = '<c:url value="/cms/inforDocument.do"/>?method=saveInforRight';
		form.submit();
...
<body onload="init();">
<br/>
<form id="inforDocumentForm" name="inforDocumentForm" action="/cms/inforDocument.do?method=saveInforRight" method="post">
<input type="hidden" name="inforId" value="${param.rowId}"/>
...
<table width="98%" cellpadding="6" cellspacing="1" align="center" border="0" bordercolor="#c5dbec">
   ...
   <tr>
      ...
      <td colspan="2">
         <table width="100%">
            <tr>
            	<td colspan="2"><input type="checkbox" onclick="selectAll(this,inforDocumentForm.addCheckBox,inforDocumentForm.editUserIds)" name="addAllCreate"/>选择全部</td>
            </tr>
	        ...
	        <c:forEach var="organize" items="${_Organizes}" varStatus="index">
		      ...
		      <tr name="tr" style="display:none;padding-top:10px;">
		      	<td width="10%" align="right" valign="top">
		      		<input type="checkbox" onclick="selectUserId(this,inforDocumentForm.editUserIds,'${organize.organizeId}')" name="addCheckBox"/>全选
		      	</td>
   ...
   <tr> 
     ...
     <td colspan="2">
		<table width="100%">
			<tr>
				<td colspan="2"><input type="checkbox" onclick="selectAll(this,inforDocumentForm.deleteCheckBox,inforDocumentForm.deleteUserIds)" name="addAllDelete"/>选择全部</td>
			</tr>
			<c:forEach var="organize" items="${_Organizes}" varStatus="index">
	            <tr height="33">
	               <td valign="bottom" width="100%" style="border-bottom:1px dotted #888888;font-size:10pt" colspan="2">
		      	...
		      	<tr name="tr" style="display:none;padding-top:10px;">
		      		<td width="10%" align="right" valign="top">
		      			<input type="checkbox" onclick="selectUserId(this,inforDocumentForm.deleteUserIds,'${organize.organizeId}')" name="deleteCheckBox"/>全选
		      		</td>
    ...
    <tr> 
       ...
       <td colspan="2">
		<table width="100%">
			<tr>
				<td colspan="2"><input type="checkbox" onclick="selectAll(this,inforDocumentForm.browseCheckBox,inforDocumentForm.viewUserIds)" name="addAllView"/>选择全部</td>
			</tr>
			<c:forEach var="organize" items="${_Organizes}" varStatus="index">
	           <tr height="33">
	              <td valign="bottom" width="100%" style="border-bottom:1px dotted #888888;font-size:10pt" colspan="2">
		       ...
		       <tr name="tr" style="display:none;padding-top:10px;">
		      	 <td width="10%" align="right" valign="top">
		      		<input type="checkbox" onclick="selectUserId(this,inforDocumentForm.viewUserIds,'${organize.organizeId}')" name="browseCheckBox"/>全选
		      	 </td>
		      	 <td style="padding-left:50px;">
		      		<table>
		      			<tr>
