...
<script>
	...
	//alert(1212);
	    ...
	    htmlsrc=htmlsrc + '<tr>';    	    
	    htmlsrc=htmlsrc + '<td ><textarea rows="5" cols="80" name="content" ></textarea></td></tr>';
...
<table width="80%" cellpadding="6" cellspacing="1" align="center" border="0" bordercolor="#c5dbec">
	...
	<tr>
		<td colspan="3"  align="center"><h2><font id="aaa">${_Topic.topicName}</font></h2></td>
	</tr>
  ...
  <tr>
		...
		<table cellpadding="0" cellspacing="0"  style="border:1px dotted #0DE8F5;" width="80%" style="margin-bottom:0;margin-top:0">
						
						<tr >
							<td style="border:1px dotted #0DE8F5;"  width="20">
								<b>排序号</b>
									
							</td>
							<td style="border:1px dotted #0DE8F5;"  width="80">
							...
							<td style="border:1px dotted #0DE8F5;" width="200">
								<b>描述</b>
									
							</td>
							<td  style="border:1px dotted #0DE8F5;" width="40">
								<b>操作</b>
	...
	<tr>
		<td colspan=3 width="40%"  align="left">&nbsp;&nbsp;&nbsp;&nbsp;<font color="#15A7BC"><b>编辑人员信息</b></font></td>
	</tr>
