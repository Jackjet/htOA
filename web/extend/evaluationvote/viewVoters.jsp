...
<table style="float:left;" border=1 bordercolor="#0DE8F5" width="15%">
	...
	<c:forEach items="${_TopicInfor.voteInfors}" var="voteInfor" varStatus="index">
		<tr>
			<td  align="center" colspan=3 style="font-family:微软雅黑;">
	...
	<tr onclick="disUsers('notVoteUsers');" style="cursor:pointer;">
		<th  height="40" colspan=3><font color="red" style="font-size:15px;font-family:微软雅黑;"><b>未投票人员</b></font>
			<br/>
			<font color=gray style="font-family:微软雅黑;">（点击显示/隐藏）</font>
		</th>
	</tr>
