...
<table width="98%" cellpadding="6" cellspacing="1" align="center" border="0" bordercolor="#c5dbec">
		...
		<tr>
		<td  align="center">
			<h2><font color="white">${_Topic.topicName}</font></h2>
			<div style="text-align:left;padding-left:10px;"><font color="#bcbcbc">${_Topic.descrip}</font></div>
			<c:if test="${!empty _Topic.ruler}">
				<br/>
				<div style="text-align:left;padding-left:10px;"><font color=orange><b>投票规则：</b></font><font color="#bcbcbc">${_Topic.descrip}</font></div>
			</c:if>
			<br/>
	...
	<tr>
		<td valign=top style="padding-top:10px;">
			<table id="optionTab" class="optionTab" width="90%" style="border:1px dotted #0DE8F5;">
				<tr>
