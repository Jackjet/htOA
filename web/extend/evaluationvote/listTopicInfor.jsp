...
<script type="text/javascript">
	...
	function addPyTopicInfor(){
        ...
        window.open("/extend/pyTopicInfor.do?method=edit", "_blank");
	}
	...
	function editPyTopicInfor(rowId){
        ...
        window.open("/extend/pyTopicInfor.do?method=edit&rowId="+rowId, "_blank");
	}
	...
	function editPyItemInfor(rowId){
        ...
        window.open("/extend/pyItemInfor.do?method=edit&rowId="+rowId, "_blank");
	}
	//查看
		...
		var returnStr=""
		  ...
		  if("${_SYSTEM_USER.userType == 1}" == 'true' || "${_TOPIC_OPERATOR}" == 'true'){
		        var returnStr = "<a href='javascript:;' onclick='editPyTopicInfor("+options.rowId+")'>[修改]</a>";
		      	returnStr = returnStr + "&nbsp;<a href='javascript:;' onclick='editPyItemInfor("+options.rowId+")'>[设计]</a>";
