					...
					<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 90%;">
						<tbody id="flowTemplate">
							...
							<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
								...
								<td colspan="3"><input id="score" name="score" value="${templateInfo.score}" onkeyup="value=value.replace(/[^0-9.]/g,'')"/><div id="instanceScoreTip"></div></td>
							</tr>
							<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
								<td class="ui-state-default jqgrid-rownum" style="width: 18%">标准：</td>
								<td colspan="3"><input id="standard" value="${templateInfo.standard}" name="standard"/><div id="instanceStandardTip"></div></td>
							</tr>
							<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
								...
								<td colspan="3">
									<select id="type" name="type">
										...
										<option <c:if test="${templateInfo.type=='技术标'}">selected="selected"</c:if> value="技术标">技术标</option>
										<option  <c:if test="${templateInfo.type=='商务标'}">selected="selected"</c:if> value="商务标">商务标</option>
									</select>
