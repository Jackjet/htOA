...
&lt;%&ndash;<script src="<c:url value="/"/>components/jqgrid/js/jquery-ui-1.8.2.custom.min.js" type="text/javascript"></script> <!--jquery ui-->&ndash;%&gt;
...
&lt;%&ndash;<link rel="stylesheet" type="text/css" media="screen" href="<c:url value="/"/>components/jqgrid/css/jquery-ui-1.7.2.custom.css" />&ndash;%&gt;
...
<body>
<!-- #LeftPane -->
<div class="ui-layout-west ui-widget ui-widget-content" id="LeftPane" style="overflow:hidden;position:relative;	border: 1px solid #0de8f5;border-radius:5px;padding: 0 auto;">
	<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
		<div class="ui-jqgrid-view">
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
				<span class="ui-jqgrid-title">登录日志</span>
			</div>
				...
				<table cellspacing="0" cellpadding="0" border="0" id="west-grid">
					<tbody>
						<tr class="ui-widget-content jqgrow ui-row-ltr" onmouseover="over(this,'ui-state-hover jqgrow ui-row-ltr')" onmouseout="out(this)" onclick="clicked(this)">
							...
							<td title="登录日志" style="width: 193px;" id="tabMenu"><div style="width: 36px;" class="tree-wrap tree-wrap-ltr"><div class="ui-icon ui-icon-document-b tree-leaf" style="left: 18px;"></div></div><span style="cursor: pointer;">登录日志</span></td>
							<td style="display: none; width: 1px;" id="tabUrl">listLoginLog.jsp</td>
						</tr>
						<tr class="ui-widget-content jqgrow ui-row-ltr" onmouseover="over(this,'ui-state-hover jqgrow ui-row-ltr')" onmouseout="out(this)" onclick="clicked(this)">
							<td style="display: none; width: 1px;" id="tabId">2</td>
							<td title="app模块使用记录" id="tabMenu"><div style="width: 36px;" class="tree-wrap tree-wrap-ltr"><div class="ui-icon ui-icon-document-b tree-leaf" style="left: 18px;"></div></div><span style="cursor: pointer;">app模块使用记录</span></td>
							<td style="display: none; width: 1px;" id="tabUrl">listAppModuleLog.jsp</td>
						</tr>
