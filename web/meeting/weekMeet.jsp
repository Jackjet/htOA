...
<body style="background-color:transparent;border: 0 #0DE8F5 solid;color: #bcbcbc;overflow-y: auto" text="#000000" topmargin=0 leftmargin=0>
...
<table width="600" 0 border="0" align="center" cellpadding="0"
	...
	<tr>
		<table align="center"  height="50">
			...
			<tr>
				<th>
					<a href="<c:url value="/meeting"/>/meetInfor.do?method=viewIndex&n=${_N-1}" title="上个月"><img width="23" height="18" border="0" src="<c:url value="/images"/>/arrow_left.gif">
					</a>
					<span class="TotCatalogHead">一周会议安排</span>
					<a href="<c:url value="/meeting"/>/meetInfor.do?method=viewIndex&n=${_N+1}" title="下个月"><img width="25" height="20" border="0" src="<c:url value="/images"/>/arrow_right.gif">
					</a>
					<br>
	...
	<tr>
		<table width="100%" align="center" border="1"  cellpadding="4" cellspacing="1">
			...
			<tr align="center" height="35">
				...
				<td width="10%" align="center">星期一

				</td>

				<td width="10%" align="center">星期二

				</td>
				<td width="10%" align="center">星期三

				</td>
				<td width="10%" align="center">星期四

				</td>
				<td width="10%" align="center">星期五

				</td>
				<td width="10%" align="center">星期六

				</td>
				<td width="10%" align="center">星期日
