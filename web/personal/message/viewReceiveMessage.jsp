...
<body  onload="window.opener.location.href=window.opener.location.href;" style="padding: 0 100px">
<br/>
<form>
...
<div class="ui-jqgrid-view" id="gview_grid_35" style="width: 100%">
  <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
    <span class="ui-jqgrid-title">查看讯息</span>
  </div>
			...
			<div>
				<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 100%">
					<tbody>
						...
						<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
							<td style="width: 10%;" class="ui-state-default jqgrid-rownum">收件人：</td>
