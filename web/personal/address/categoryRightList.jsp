...
<title>个人通讯录</title>
	<div>
		<table id="list${param.categoryId}"></table> <!-- 信息列表 -->
		<div id="pager${param.categoryId}"></div> <!-- 分页 -->
	</div>
	...
	<script type="text/javascript"> 
	   ...
	   //自定义性别的显示内容
		...
		var $mygrid = jQuery("#list"+${param.categoryId}).jqGrid({
            url:'/personal/address/personalAddressInfor.do?method=categoryList&categoryId='+${param.categoryId},
            ...
            pager: "#pager"+${param.categoryId}	//分页工具栏
            //caption: "用户信息"	//表头
		...
		function deleteAddress(){
			doDelete("/personal/address/personalAddressInfor.do?method=delete","list"+${param.categoryId});
		}
