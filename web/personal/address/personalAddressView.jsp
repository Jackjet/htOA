...
<html>
	...
	<body>
		<form:form commandName="personalAddressVo" id="personalAddressForm" name="personalAddressForm" action="/personal/personalAddressInfor.do?method=save" method="post">
			<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" id="gbox_grid_35" dir="ltr" style="width: 100%">
				<div class="ui-jqgrid-view" id="gview_grid_35" style="width: 100%">
				  <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
				    <span class="ui-jqgrid-title">个人通讯录详细信息</span>
				  </div>
								...
								<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 100%">
									<tbody>
										<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
											<td style="width: 15%;" class="ui-state-default jqgrid-rownum">分类：</td>
											<td><c:choose><c:when test="${empty _message}">&nbsp;</c:when><c:otherwise>${_message.category.categoryName }</c:otherwise></c:choose></td>
										</tr>
