...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px">
            <li id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">已收到的讯息</a></li>
            <li id="tabs_li_2" class="tabs_li"><a href="#tabs-grant">已发送的讯息</a></li>
        </ul>
        <div id="tabs-grant">
...
//            setFrameHeight()
        ...
        $("#tabs_ul li").click(function(){
            ...
            if(flag){
                ...
                var url = "";
                if(tabId == "tabs_li_1"){
                    url = "/personal/message/listReceiveMessage.jsp";
                } else if(tabId == "tabs_li_2"){
                    url = "/personal/message/listSendMessage.jsp";
                } else{
                    return;
                }
