				...
				<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 100%">
					<tbody>
						...
						<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 20px;">
							<td colspan=3 class="ui-state-default jqgrid-rownum"><font color=white>建议图片容量不要太大，分辨率为16：9</font></td>
						</tr>
						...
						<c:if test="${!empty _Attachment_Names}">
							<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
								<td class="ui-state-default jqgrid-rownum">原图片信息(<font color=white>如果要删除原图片，请选择该图片前面的选择框</font>)：</td>
