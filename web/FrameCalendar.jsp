...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px">
            <li id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">我的日程安排</a></li>
            <li id="tabs_li_2" class="tabs_li"><a href="#tabs-grant">安排他人日程</a></li>
            <li id="tabs_li_3" class="tabs_li"><a href="#tabs-grant">他人公开日程</a></li>
        </ul>
        <div id="tabs-grant">
...
//            setFrameHeight()
        ...
        $("#tabs_ul li").click(function(){
            ...
            if(flag){
                ...
                var url = "";
                if(tabId == "tabs_li_1"){
                    url = "/personal/schedule/listCalendar.jsp";
                } else if(tabId == "tabs_li_2"){

                    url = "/personal/schedule/listOtherCalendar.jsp";
                } else if(tabId == "tabs_li_3"){
                    url = "/personal/schedule/listOpenCalendar.jsp";
                }else{
                    return;
                }
