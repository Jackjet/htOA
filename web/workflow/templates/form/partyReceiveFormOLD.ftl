...
[#-- 注:使用自定义标签时,controlName要放在最后 --]
                ...
                <tr style="height: 30px" class="ui-widget-content jqgrow ui-row-ltr">
                    ...
                    <td colspan="3">[@select selectId="selUnitName" optionValueArray=["中共中央办公厅","中共上海市委办公厅","中共上海国际港务(集团)股份有限公司委员会","中共上海国际港务(集团)股份有限公司纪律检查委员会","中共上海国际港务(集团)股份有限公司党委工作部","其他"] controlName="selUnitName"/]</td>
                </tr>
                <tr style="display: none;">
