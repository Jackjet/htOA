...
[#-- 注:使用自定义标签时,controlName要放在最后 --]
					...
					<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
						...
						<td id="typeTd" colspan="3">[@mSelect selectId="contractType" mOptionValueArray=["销售合同","一般采购合同","物流采购合同","其他合同"] controlName="contractType"/]</td>
					</tr>
					<tr id="saleTypeTr" class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
						<td class="ui-state-default jqgrid-rownum" style="width: 15%">销售合同类型：</td>
						<td id="fff">[@mSelect selectId="saleType" mOptionValueArray=["现有业务","新增业务","创新和转型业务"] controlName="saleType"/]</td>
					</tr>
					<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
						<td class="ui-state-default jqgrid-rownum" style="width: 15%" nowrap>是否使用了公司合同模板：</td>
						<td colspan="3">[@mSelect selectId="useModel" mOptionValueArray=["是","否"] controlName="useModel"/]</td>
					</tr>
					<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
...
//
					...
					<tr style="display: none;">
						<td colspan="4">[@searchControl searchType="input" searchField="saleType" searchOper="cn" searchName="销售合同类型"/]</td>
					</tr>
					<tr style="display: none;">
