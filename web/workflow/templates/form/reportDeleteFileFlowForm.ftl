...
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum">销毁原因：</td>
    <td colspan="3">[@textarea controlName="flowDe"/]</td>
</tr>
<script>
...
<tr style="display: none;">
    <td colspan="4">[@searchControl searchType="input" searchField="fileName" searchOper="cn" searchName="文件名"/]</td>
</tr>
<tr style="display: none;">
    <td colspan="4">[@searchControl searchType="input" searchField="flowName" searchOper="cn" searchName="流程名"/]</td>
</tr>
<tr style="display: none;">
    <td colspan="4">[@searchControl searchType="input" searchField="fileNo" searchOper="cn" searchName="文件编号"/]</td>
</tr>
