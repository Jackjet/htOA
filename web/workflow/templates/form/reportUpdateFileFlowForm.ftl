...
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum" style="width: 15%">文件所属科室：</td>
...
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum">文件修改位置及原因：</td>
    <td colspan="3">[@textarea controlName="fileUpdatePo"/]</td>
</tr>

<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum">文件修改后内容：</td>
    <td colspan="3">[@textarea controlName="fileNew"/]</td>
</tr>

<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum">受此影响的其他文件名称：</td>
    <td colspan="3">[@input size="62" controlName="beAffw"/]</td>
</tr>
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum" style="width: 15%">流程名称：</td>
    <td colspan="3">[@input size="20" controlName="flowName"/]</td>
</tr>
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum" style="width: 15%">流程所属科室：</td>
    <td>[@input size="20" controlName="organizeIdl"/]
    </td>
</tr>

<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum" style="width: 15%">流程版本号：</td>
    <td colspan="3">[@input size="20" controlName="flowEdition"/]</td>
</tr>
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum">流程支持文件（包括红头文件）：</td>
    <td colspan="3">[@input size="62" controlName="flowSup"/]</td>
</tr>
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum">流程修改位置及原因：</td>
    <td colspan="3">[@textarea controlName="flowUpdatePo"/]</td>
</tr>
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum">流程修改后内容：</td>
    <td colspan="3">[@textarea controlName="flowNew"/]</td>
</tr>
<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
    <td class="ui-state-default jqgrid-rownum">受此影响的其他流程名称：</td>
    <td colspan="3">[@input size="62" controlName="beAffl"/]</td>
</tr>
<script>
