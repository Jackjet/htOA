...
<body style="border:1px solid #0DE8F5;border-radius: 5px">
		...
		<script type="text/javascript"> 		
			...
			//获取自定义列
			var col_names = ['Id', '正文标题', '创建时间', '申请人', '所属部门', '浏览人'];
			var col_model = [{name:'instanceId',index:'instanceId', width:0, sorttype:"int", search:false, key:true, hidden:true},
                    {name:'instanceTitle',index:'instanceTitle',width:260, sortable:true, sorttype:"string", formatter:formatTitle},
                    {name:'updateTime',index:'updateTime', width:100, align:'center'},
...
//	            caption: flowName,
			...
			function exportExcel(){
				...
				if (yes) {
				    ...
				    var url = "/workflow/instanceInfor.do?method=expertExcel&flowId="+${param.flowId}+"&_search=true&page=1&rows=100000&sidx=instanceId&sord=desc&filters="+filtersStr;
