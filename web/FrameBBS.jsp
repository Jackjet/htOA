...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px">
            <li id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">论题列表</a></li>
            <li id="tabs_li_2" class="tabs_li"><a href="#tabs-grant">我的论题列表</a></li>
            <li id="tabs_li_3" class="tabs_li"><a href="#tabs-grant">我的回复</a></li>
...
//            setFrameHeight()
        ...
        $("#tabs_ul li").click(function(){
            ...
            if(flag){
                ...
                var url = "";
                if(tabId == "tabs_li_1"){
                    url = "/bbs/listThesisInfor.jsp";
                } else if(tabId == "tabs_li_2"){

                    url = "/bbs/listMyThesisInfor.jsp";
