    ...
    <HTML>
      <HEAD>
        <TITLE>WebMail Mailbox for <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/></TITLE>
			...
			<SCRIPT src="{$imgbase}/js/MultiSelector.js" type="text/javaScript"></SCRIPT>
			...
			<SCRIPT language="javaScript">
					<xsl:comment><![CDATA[
						...
						function showWaiting() {
							...
							str = str + (document.postform.issend.value==1 ? "正在发送邮件, 请稍候" : "正在保存邮件, 请稍候")+ '...';
						...
						function DoSend() {
							...
							//alert(12345);
							//alert(document.postform.body.value);
     ...
     <DIV id="LoadingStatus" style="position:absolute; right:0px; top:0px; background:#CC0000; height:18px; color:#fff;padding:2px 10px 1px 10px;display:none;">
     		<IMG src="{$imgbase}/images/toploading.gif" align="absmiddle"/>&#160;正在加载...
     </DIV>
				  ...
				  <TBODY>
				  	<TR>
						...
						<TD class="tdmain" valign="top">
								<FORM name="postform" ACTION="{$base}/send?session-id={$session-id}" enctype="multipart/form-data"  METHOD="POST">
											...
											<TD style="padding-top:5px;">
												<TABLE width="95%" cellpadding="0" cellspacing="2" id="tbMain">
													<TR id="TRto">
														...
														<TD class="altbg2"> 
														<TEXTAREA type="text" id="to" name="to" chkName="收件人" chkRule="notnull/emls" rows="2" style="width:100%;height:36" class="ACtype" tabindex="1" onKeyDown="ctlent(event);">
													...
													<TR id="TRcc" bgcolor="#F6F6F6" style="display:none">
														...
														<TD>
															<TEXTAREA name="cc" chkName="抄送" chkRule="emls" style="width:100%;height:36" class="ACtype" tabindex="4" onKeyDown="ctlent(event);">
															<xsl:value-of select="$work/HEADER/CC"/>
															</TEXTAREA>
														</TD>
													</TR>
													<TR id="TRbcc" bgcolor="#F6F6F6" style="display:none">
														...
														<TD>
															<TEXTAREA name="bcc" chkName="暗送" chkRule="emls" style="width:100%;height:36" class="ACtype" tabindex="5" onKeyDown="ctlent(event);">
															<xsl:value-of select="$work/HEADER/BCC"/>
															</TEXTAREA>
														</TD>
													</TR>
													<TR style="height:28">
														...
														<TD class="altbg2">
															<INPUT type="text" name="subject" id="subject" style="width:100%" onKeyDown="ctlent(event);" tabindex="6" VALUE="{$work/HEADER/SUBJECT}"/>
														</TD>
													</TR>
													<!-- 
												...
												<TD bgcolor="#EFEFEF" style="padding:5px 0px 5px 0px;border-top:1px solid #E1E1E1;">
													...
													<TR>
														<TD align="right" valign="top" style="width:80;padding-top:3px;">
															附件:&#160;<IMG src="{$imgbase}/images/paperclip.gif" align="absmiddle"/>&#160;
														</TD>
														<TD id="TDAttach">
													...
													<TD align="left" class="altbg2" valign="top">										
														<DIV id="posteditor">
															...
															<SCRIPT language="javaScript">
																...
																//$("previewmessage").innerHTML = $('postform').message.value;
															...
															<SCRIPT type="text/javaScript" src="{$imgbase}/js/editor.js"></SCRIPT>
																...
																<TABLE cellpadding="0" cellspacing="0" border="0">
																		<TR>
																			...
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_removeformat" onClick="discuzcode('removeformat')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')">
																				<IMG src="{$imgbase}/images/bb_removeformat.gif" width="21" height="20" title="清除文本格式" alt="清除文本格式" /></DIV>
																			</TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_undo" onClick="discuzcode('undo')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_undo.gif" width="21" height="20" title="撤消" alt="撤消" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_redo" onClick="discuzcode('redo')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_redo.gif" width="21" height="20" title="重做" alt="重做" /></DIV></TD>
																			
																			<TD><IMG src="{$imgbase}/images/bb_separator.gif" width="6" height="20" alt=""/></TD>
																			
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_bold" onClick="discuzcode('bold')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_bold.gif" width="21" height="20" title="粗体" alt="粗体" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_italic" onClick="discuzcode('italic')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_italic.gif" width="21" height="20" title="斜体" alt="斜体" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_underline" onClick="discuzcode('underline')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_underline.gif" width="21" height="20" title="下划线" alt="下划线" /></DIV></TD>
																			...
																			<TD id="posteditor_popup_fontname" title="字体">
																				<DIV class="editor_buttonnormal" onMouseOver="menuContext(this, 'mouseover')" onMouseOut="menuContext(this, 'mouseout')">
																					<TABLE cellpadding="0" cellspacing="0" border="0" unselecTABLE="on">
																						...
																						<TD unselecTABLE="on"><IMG src="{$imgbase}/images/bb_menupop.gif" width="7" height="4" alt="" /></TD>
																						</TR>
																					</TABLE>
																					<SCRIPT language="javaScript">
																						<xsl:comment><![CDATA[
																				...
																				<DIV class="editor_buttonnormal" onMouseOver="menuContext(this, 'mouseover')" onMouseOut="menuContext(this, 'mouseout')">
																					...
																					<TR>																						
																						<TD class="editor_colormenunormal" unselecTABLE="on" id="posteditor_colormenu">
																							<IMG src="{$imgbase}/images/bb_color.gif" width="21" height="16"/><BR/>
																							<IMG src="{$imgbase}/images/bb_clear.gif" id="posteditor_color_bar" style="background-color:black" width="21" height="4"/>
																						</TD>																					
																						<TD unselecTABLE="on"><IMG src="{$imgbase}/images/bb_menupop.gif" width="7" height="4" alt="" /></TD>
																					</TR>
																					</TABLE>
																			...
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_justifyleft" onClick="discuzcode('justifyleft')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_left.gif" width="21" height="20" title="居左" alt="居左" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_justifycenter" onClick="discuzcode('justifycenter')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_center.gif" width="21" height="20" title="居中" alt="居中" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_justifyright" onClick="discuzcode('justifyright')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_right.gif" width="21" height="20" title="居右" alt="居右" /></DIV></TD>
																			
																			<TD><IMG src="{$imgbase}/images/bb_separator.gif" width="6" height="20" alt="" /></TD>
																			
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_insertorderedlist" onClick="discuzcode('insertorderedlist')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_orderedlist.gif" width="21" height="20" title="排序的列表" alt="排序的列表" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_insertunorderedlist" onClick="discuzcode('insertunorderedlist')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_unorderedlist.gif" width="21" height="20" title="未排序列表" alt="未排序列表" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_ouTDent" onClick="discuzcode('ouTDent')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_outdent.gif" width="21" height="20" title="减少缩进" alt="减少缩进" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_indent" onClick="discuzcode('indent')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_indent.gif" width="21" height="20" title="增加缩进" alt="增加缩进" /></DIV></TD>
																			<TD><IMG src="{$imgbase}/images/bb_separator.gif" width="6" height="20" alt="" /></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_createlink" onClick="discuzcode('createlink')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_url.gif" width="21" height="20" title="插入链接" alt="插入链接" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_unlink" onClick="discuzcode('unlink')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_unlink.gif" width="21" height="20" title="移除链接" alt="移除链接" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_email" onClick="discuzcode('email')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_email.gif" width="21" height="20" title="插入邮箱链接" alt="插入邮箱链接" /></DIV></TD>
																			<TD><DIV class="editor_buttonnormal" id="posteditor_cmd_TABLE" onClick="discuzcode('table')" onMouseOver="buttonContext(this, 'mouseover')" onMouseOut="buttonContext(this, 'mouseout')"><IMG src="{$imgbase}/images/bb_table.gif" width="21" height="20" title="插入表格" alt="插入表格" /></DIV></TD>
																		</TR>
																	</TABLE>
															...
															<DIV class="editor_text" style="width:100%;">
																<TEXTAREA name="message" rows="10" cols="60" style="width:99%; height:250px;font-size:14px;font-family:Arial;padding:5px;" id="posteditor_TEXTAREA" onSelect="javaScript: storeCaret(this);" onClick="javaScript: storeCaret(this);" onKeyUp="javaScript:storeCaret(this);" onKeyDown="ctlent(event);" tabindex="100">													
																	...
																	<PRE><xsl:value-of select="/USERMODEL/USERDATA/SIGNATURE"/></PRE>
																</TEXTAREA>
															</DIV>
															...
															<TABLE width="100%" cellpadding="4" cellspacing="0" class="editor_button">
																<TR><TD>
																	...
																	<IMG src="{$imgbase}/images/zoomout.gif" width="14" height="13" title="收缩编辑框" alt="收缩编辑框" onClick="resizeEditor(-100)" />&#160; 
																	<IMG src="{$imgbase}/images/zoomin.gif" width="14" height="13" title="扩展编辑框" alt="扩展编辑框" onClick="resizeEditor(100)" /></DIV>
																</TD></TR>
															</TABLE>
