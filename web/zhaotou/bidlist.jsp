...
<script type="text/javascript">
    ...
    jQuery("#list").jqGrid(
        {
            url: "/bid.do?method=bidInfoList&type=" + GetQueryString("type"),
            rownumbers: true,
            datatype: "json",
            width: "90%",
            autowidth: true,
            ...
            colModel: [
                ...
                {name: 'zbcode', index: 'zbcode', width: 100, align: 'center'},
                {name: 'zhaotouStatus', index: 'zhaotouStatus', width: 100, align: 'center', formatter: formatStatus}
            ],
            sortorder: 'desc',
    ...
    function formatTitle(cellValue, options, rowObject) {
        var html = '';
        html = "<a href='javascript:;' onclick='doView(" + rowObject.bidInfoId + ")'>" + cellValue + "</a>";
        return html;
    }
    //查看
    function doView(bidInfoId) {
        window.open("/bid.do?method=view&bidInfoId=" + bidInfoId, "_blank");
    }
</script>