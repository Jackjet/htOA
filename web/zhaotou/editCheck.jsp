	...
	<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" id="gbox_grid_35" dir="ltr" style="width: 98%">
		<div class="ui-jqgrid-view" id="gview_grid_35" style="width: 100%">
			<div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="color: #22FBFF">
				<span class="ui-jqgrid-title">审批 &nbsp;【招投标 主办人:${bidInfo.purchaseExecutor.person.personName}  发起时间:${sanfangInfor.startTime}】</span>
			</div>
				...
				<tbody>
					<tr  class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
						...
						<td>
							...
							%>
							日期：<input id="checkTime" name="checkDate" value="<%=format%>"/><br/>
							<textarea name="checkMemo" cols="70"></textarea>
						</td>
					</tr>
