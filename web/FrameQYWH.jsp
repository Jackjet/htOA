...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px;height: 5px;display: none">
            <li style="margin-left: 80px;height: 0px" id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">企业文化</a></li>

        </ul>
        <div id="tabs-grant">
            <img src="images/qiyewenhua.jpg" id="img" />
...
<script>
    ...
    $(function() {
        $("#img").css("width",document.documentElement.clientWidth);
        <%--alert("${param.flowId}");--%>
...
//            setFrameHeight()
        ...
        $("#tabs_ul li").click(function(){
            ...
            if(flag){
                ...
                var url = "";
                if(tabId == "tabs_li_1"){
                    url ="/cms/"+urlPath+".do?method=list";
                }
