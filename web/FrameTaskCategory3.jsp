...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px;height: 5px;display: none">
            <li style="margin-left: 80px;height: 0px" id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">部门建设</a></li>
...
//            setFrameHeight()
        ...
        $("#tabs_ul li").click(function(){
            ...
            if(flag){
                ...
                var url = "";
                if(tabId == "tabs_li_1"){
                    url = "/supervise/taskCategory.do?method=listBase&categoryType=3";
                }
