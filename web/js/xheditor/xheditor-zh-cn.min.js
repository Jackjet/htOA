...
d('<div style="width:200px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">kwchina</span><br />shang hai huizhi</p></div>');b.showDialog(a)};this.attr=function(a,c,e){if(!c)return false;var h="_xhe_"+c;e&&a.attr(c,e).removeAttr(h).attr(h,
