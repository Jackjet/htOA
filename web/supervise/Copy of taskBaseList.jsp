	...
	<head>
		...
		<script type="text/javascript">
			$().ready(function(){
				...
				//加载首页
				$.ajax({
					url: "taskRightList.jsp?isRoot=true&categoryId="+${_Category.categoryId},
					type: "GET",
					dataType: "html",
		    	...
		    	jQuery("#west-grid").jqGrid({
			        url: "/supervise/taskCategory.do?method=getCategoryTree&categoryId="+${_Category.categoryId},
			        datatype: "json",
			        treedatatype: "json",
			        height: "auto",
			        pager: false,	        
			        ...
			        onSelectRow: function(rowid) {
			            ...
			            if(treedata.categoryName!="行政类" && treedata.categoryName!="党群类") {
			            ...
			            //if(treedata.parent.categoryId != 1){
							...
							if($(st).html() != null ) {
								...
								$.ajax({
									url: "taskRightList.jsp?categoryId="+treedata.categoryId+"&leaf="+treedata.leaf,
									cache: false,
									type: "GET",
									dataType: "html",
									beforeSend: function (xhr) {
