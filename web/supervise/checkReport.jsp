...
<body onload="window.scrollTo(0,document.body.scrollHeight); ">
	<form:form commandName="superviseReportVo" name="superviseReportForm" id="superviseReportForm" action="/supervise/superviseReport.do?method=saveCheck" method="post" enctype="multipart/form-data">
								...
								<tbody id="setOperatorBody">
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 20px;">
										<td class="ui-state-default jqgrid-rownum" colspan=4>
											<b><font color=red>审核报告</font></b>
										</td>
									</tr>
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
										<td class="ui-state-default jqgrid-rownum" >审核日期：</td>
										<td colspan=3>
											<input name="operateDate" id="operateDate" size="20" value="${_CheckDate}" readonly="readonly" /><!--  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" -->
									...
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
										...
										<td valign="top" colspan=3>
											<form:radiobutton path="isPassed" value="1"/>通过&nbsp;&nbsp;
