...
<body onload="window.scrollTo(0,document.body.scrollHeight); ">
	<form:form commandName="superviseReportVo" name="superviseReportForm" id="superviseReportForm" action="/supervise/superviseReport.do?method=saveCheckAdvice" method="post" enctype="multipart/form-data">
								...
								<tbody id="setOperatorBody">
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 20px;">
										<td class="ui-state-default jqgrid-rownum" colspan=4>
											<b><font color=red>工作跟踪评价</font></b><!-- 打分 -->
										</td>
									</tr>
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
										<td class="ui-state-default jqgrid-rownum" >审核日期：</td>
										<td colspan=3>
											<input name="operateDate" id="operateDate" size="20" value="${_CheckDate}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'%y-%M-%d'})" readonly="readonly" />
									...
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
										...
										<td valign="top" colspan=3>
											<form:radiobutton path="isPassed" value="1" checked="checked"/>通过&nbsp;&nbsp;
											<form:radiobutton path="isPassed" value="0"/>不通过
										</td>
									</tr>
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;display:none;">
										<td class="ui-state-default jqgrid-rownum" >评价：</td>
										<td valign="middle" colspan=3>
											<input type="radio" name="nameScore" value="1" checked/>满意&nbsp;&nbsp;
											<input type="radio" name="nameScore" value="0"/>不满意
										</td>
									</tr>
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
