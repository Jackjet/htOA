...
<script language="javaScript">
	...
	//提交数据
	function submitData() {
		var form = document.documentInforForm;
		form.action = '<c:url value="/document/document.do"/>?method=saveInforRight';
        var browserName=navigator.userAgent.toLowerCase();
        if(/chrome/i.test(browserName) && /webkit/i.test(browserName) && /mozilla/i.test(browserName)){
            //如果是chrome浏览器
            $.ajax({
                type: "POST",
                url:'<c:url value="/document/document.do"/>?method=saveInforRight',
                data:$('#documentInforForm').serialize(),
                async: false
            });
...
<body onload="init();">
<br/>
<form id="documentInforForm" name="documentInforForm" action="/document/document.do?method=saveInforRight" method="post">
<input type="hidden" name="documentId" value="${param.rowId}"/>
<input type="hidden" name="categoryId" id="categoryId" value="${_CategoryId}"/>
<input type="hidden" name="fromReport" id="fromReport" value="${fromReport}"/>
<table id="dtable" width="98%" cellpadding="6" cellspacing="1" align="center" <%--style="border:1px dotted #0DE8F5;"--%> >
   <tr>
	 <td colspan="2" ></td>
   </tr>
   ...
   <tr>
      ...
      <td colspan="2">
         <table width="100%">
            <tr>
            	<td colspan="2"><input type="checkbox" onclick="selectAll(this,documentInforForm.addCheckBox,documentInforForm.editUserIds)" name="addAllCreate"/>选择全部</td>
            </tr>
	        ...
	        <c:forEach var="organize" items="${_Organizes}" varStatus="index">
		      ...
		      <tr name="tr" style="display:none;padding-top:10px;">
		      	<td width="10%" align="right" valign="top">
		      		<input type="checkbox" onclick="selectUserId(this,documentInforForm.editUserIds,'${organize.organizeId}')" name="addCheckBox"/>全选
		      	</td>
   ...
   <tr> 
     ...
     <td colspan="2">
		<table width="100%">
			<tr>
				<td colspan="2"><input type="checkbox" onclick="selectAll(this,documentInforForm.deleteCheckBox,documentInforForm.deleteUserIds)" name="addAllDelete"/>选择全部</td>
			</tr>
			<c:forEach var="organize" items="${_Organizes}" varStatus="index">
	            <tr height="33">
	               <td valign="bottom" width="100%" style="border-bottom:1px dotted #888888;font-size:10pt" colspan="2">
		      	...
		      	<tr name="tr" style="display:none;padding-top:10px;">
		      		<td width="10%" align="right" valign="top">
		      			<input type="checkbox" onclick="selectUserId(this,documentInforForm.deleteUserIds,'${organize.organizeId}')" name="deleteCheckBox"/>全选
		      		</td>
    ...
    <tr> 
       ...
       <td colspan="2">
		<table width="100%">
			<tr>
				<td colspan="2"><input type="checkbox" onclick="selectAll(this,documentInforForm.browseCheckBox,documentInforForm.viewUserIds)" name="addAllView"/>选择全部</td>
			</tr>
			<c:forEach var="organize" items="${_Organizes}" varStatus="index">
	           <tr height="33">
	              <td valign="bottom" width="100%" style="border-bottom:1px dotted #888888;font-size:10pt" colspan="2">
		       ...
		       <tr name="tr" style="display:none;padding-top:10px;">
		      	 <td width="10%" align="right" valign="top">
		      		<input type="checkbox" onclick="selectUserId(this,documentInforForm.viewUserIds,'${organize.organizeId}')" name="browseCheckBox"/>全选
		      	 </td>
		      	 <td style="padding-left:50px;">
		      		<table>
		      			<tr>
