...
<br/>
<form:form commandName="purchaseInforVo" id="purchaseInforForm" name="purchaseInforForm" action="/ybpurchase/purchaseInfor.do?method=saveEnd" method="post" enctype="multipart/form-data">
