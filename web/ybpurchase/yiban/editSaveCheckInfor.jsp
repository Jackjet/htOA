...
<br/>
<form:form commandName="purchaseCheckInforVo" id="purchaseCheckInforForm" name="purchaseCheckInforForm" action="/ybpurchase/checkInfor.do?method=editSave" method="post" enctype="multipart/form-data">
