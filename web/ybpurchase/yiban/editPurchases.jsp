...
<head>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$("#purchaseGoodss_0").formValidator({onshow:"请输入单位",onfocus:"单位不能为空"}).inputValidator({min:1,onerror: "请输入单位"});
//			$("#guiges_0").formValidator({onshow:"请输入规格",onfocus:"规格不能为空"}).inputValidator({min:1,onerror: "请输入规格"});
//			$("#application_0").formValidator({onshow:"请输入用途",onfocus:"用途不能为空"}).inputValidator({min:1,onerror: "请输入用途"});
...
<br/>
	<form:form commandName="purchaseInforVo" id="purchaseInforForm" name="purchaseInforForm" action="/ybpurchase/purchaseInfor.do?method=saves" method="post" enctype="multipart/form-data">
				...
				<div>
					...
					<table cellspacing="0" cellpadding="0" border="0" >
						<tr><td style="width: 65%;">
								...
								<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 98%" >
									<tbody>
									<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">
										<td class="ui-state-default jqgrid-rownum" style="width: 9%">标题：</td>
										<td>
											<input name="purchaseStr1" value="月度需求表" id="purchaseStr1_0" size="35" />
											<font color="red">*</font>
										</td>
									</tr>
								</tbody>
							...
							<table cellspacing="0" cellpadding="0" border="0" class="ui-jqgrid-btable" style="width: 100%" >
								<tbody>
									<tr class="ui-widget-content jqgrow " style="height: 30px;">
										<td class="ui-state-default jqgrid-rownum" style="width: 9%">采购物品：</td>
										<td>
									...
									<%--<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">--%>
										...
										<td style="width: 9%">
											<input name="purchaseGoodss" id="purchaseGoodss_0" size="5" />
											<font color="red">*</font>
										</td>
									<%--</tr>--%>
									<%--<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">--%>
										<td class="ui-state-default jqgrid-rownum" style="width: 4%">规格：</td>
										<td>
											<input name="guiges" id="guiges_0" size="15" />

										</td>
									<%--</tr>--%>
									<%--<tr class="ui-widget-content jqgrow ui-row-ltr" style="height: 30px;">--%>
										<td class="ui-state-default jqgrid-rownum" style="width: 4%">用途：</td>
										<td>
...
//                                            $("#batchDiv2"+idNum).remove();
//                                            $("#batchDiv3"+idNum).remove();
//                                            $("#batchDiv4"+idNum).remove();
//                                            $("#batchDiv5"+idNum).remove();
//                                            $("#batchDiv6"+idNum).remove();
                                        }
                                        var clickNum = 1;
                                        function addPurchase(){
                                            ...
                                            "<td class='ui-state-default jqgrid-rownum' style='width: 4%'>单位：</td>"+
                                            "<td style='width: 9%'><input name='purchaseGoodss' size='5' />"+
                                            "&nbsp;<font color='red'>*</font></td>"+

                                            "<td class='ui-state-default jqgrid-rownum' style='width: 4%'>规格：</td>"+
                                            "<td><input name='guiges' size='15' />"+
                                            "&nbsp;<font color='red'>*</font></td>"+
