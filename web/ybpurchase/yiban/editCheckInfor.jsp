...
<br/>
<form:form commandName="purchaseCheckInforVo" id="purchaseCheckInforForm" name="purchaseCheckInforForm" action="/ybpurchase/checkInfor.do?method=save" method="post" enctype="multipart/form-data">
