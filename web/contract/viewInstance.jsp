...
<head>
	...
	<script type="text/javascript">
        ...
        //审核
        function check(contractID){
            var path = "/contract.do?method=edit&contractID=" + contractID;
           commonFun(path);
        }
		...
		<div class="ui-jqgrid-view" id="gview_grid_35" style="width: 100%">
			...
			<div style="width: 100%" class="ui-state-default ui-jqgrid-pager ui-corner-bottom" dir="ltr">
				<c:if test="${_CanReview}">
					<input style="cursor: pointer;" type="button" value="审核文件" onclick="check('${contractInfo.contractID}');"/>
				</c:if>
				&nbsp;&nbsp;
