...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px">
            <li id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">投票</a></li>
            <li id="tabs_li_2" class="tabs_li"><a href="#tabs-grant">问卷</a></li>
            <li id="tabs_li_3" class="tabs_li"><a href="#tabs-grant">评优系统</a></li>
        </ul>
        <div id="tabs-grant">
...
//            setFrameHeight()
        ...
        $("#tabs_ul li").click(function(){
            ...
            if(flag){
                ...
                var url = "";
                if(tabId == "tabs_li_1"){
                    url = "/extend/tpwj/listTopicInfor.jsp?type=0";
                } else if(tabId == "tabs_li_2"){
                    url = "/extend/tpwj/listTopicInfor.jsp?type=1";
                } else if(tabId == "tabs_li_3"){
                    url = "/extend/evaluationvote/listTopicInfor.jsp";
                } else{
                    return;
                }
