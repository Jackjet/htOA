...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px;height: 5px;display: none">
            <li id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">流程定义</a></li>

        </ul>
        <div id="tabs-grant">
            <iframe style="border: 1px solid #0DE8F5;border-radius: 5px"  id="grant_iframe" class="tab_iframe" allowtransparency=true src="" frameborder="0" scrolling="yes" width="100%" ></iframe>
        </div>
    ...
    $(function() {
        ...
        $( "#tabs" ).tabs({
            ...
            load: function(event, ui) {
                ...
                var url = "/workflow/listFlowDefinition.jsp";
