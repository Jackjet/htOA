...
<!-- Tabs -->
    <div id="tabs" >
        <ul id="tabs_ul" style="margin-left: 80px;margin-bottom: 6px">
            <c:if test="${param.msg == 1}">
               <li id="tabs_li_1" class="tabs_li"><a href="#tabs-grant">手机短信发送</a></li>
            </c:if>
            <c:if test="${param.msg == 2}">
              <li id="tabs_li_2" class="tabs_li"><a href="#tabs-grant">手机短信记录</a></li>
            </c:if>
        </ul>
        <div id="tabs-grant">
            <iframe  id="grant_iframe" style="border: 1px solid #0DE8F5;border-radius: 5px" class="tab_iframe" allowtransparency=true src="" frameborder="0" scrolling="yes" width="100%" height="95%" ></iframe>
        </div>
...
//            setFrameHeight()
        ...
        $( "#tabs" ).tabs({
            ...
            load: function(event, ui) {
                ...
                $('.tab_iframe').height((ViewPortHeight() - $('#tabs_ul').height()-10/* - heightAdjust*/));
            }
        });
        ...
        $("#tabs_ul li").click(function(){
            ...
            if(flag){
                ...
                var url = "";
                if(tabId == "tabs_li_1"){
                    url = "/sms/addMessage.jsp";
                } else if(tabId == "tabs_li_2"){
                    url = "/sms/messageQuery.jsp";
                } else{
                    return;
                }
