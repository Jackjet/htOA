...
public class InforDocumentRight {
    ...
    private InforDocument document;	//文档信息
    ...
    public InforDocument getDocument() {
        return this.document;
    }
    
    public void setDocument(InforDocument document) {
