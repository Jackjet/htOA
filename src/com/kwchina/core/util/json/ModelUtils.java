...
public class ModelUtils {
    ...
    public static void main(String[] args) {
        String testStr01 = "{\"idStr\":\"haha\"}";
        //log.info(convertObj(JSONObject.fromObject(testStr01), User.class));
        String testStr02 = "[{\"idStr\":\"haha\"},{\"idStr\":\"haha2\"}]";
        //log.info(convertObj(JSONArray.fromObject(testStr02), User.class));
    }
   ...
   // }
    ...
    /**
     * 根据一个方法名，得到它的属性名，方法有三种:get方法,set方法和is方法，属性名第一个强制变小写
     * @param methodName
     * @return
     */
