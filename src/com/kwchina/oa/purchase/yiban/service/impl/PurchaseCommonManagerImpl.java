...
import com.kwchina.oa.purchase.yiban.service.PurchaseCommonManager;
...
@Service("purchaseCommonManager")
public class PurchaseCommonManagerImpl implements PurchaseCommonManager {
...
//			hibernateUtil.reset();
	...
	public List getFormData(String flowName, Integer instanceId) {
		...
		String sql = "select * from Purchase_" + flowName + " where purchaseId='" + instanceId + "'";
