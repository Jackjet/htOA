...
public class SendMessage
{
	public void doIt() throws Exception
	{
		...
		srv = new Service();
		SerialModemGateway gateway = new SerialModemGateway("jindi", "COM6", 115200, "wavecom", "M1306B");
		...
		msg = new OutboundMessage("18930352231", "您好！欢迎使用金笛JAVA短信开发包。www.sendsms.cn");
...
//		String[] params = {"5678"};
//		a.SMSSendMessageSingle("18732188764",115409,params);
